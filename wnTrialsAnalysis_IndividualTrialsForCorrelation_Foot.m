...
scatter(Dsum(1,:),oddball_allFoot(1,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(2, :));
hold on;
scatter(Dsum(1,:),oddball_allFoot(3,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(4,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(5,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(6,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(7,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(8,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(9,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(10,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(11,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(12,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(13,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(14,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(15,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(16,:));
hold on;
scatter(Dsum(1,:),oddball_allFoot(17,:));
hold on;

[RFootwn2,PFootwn2]= corrcoef(Dsum(:,:),oddball_allFoot(:,:));
%% correlation without wn2
scatter(Dsum(1,[1 3:8]),oddball_allFoot(1,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(2,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(3,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(4,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(5,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(6,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(7,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(8,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(9,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(10,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(11,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(12,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(13,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(14,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(15,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(16,[1 3:8]));
hold on;
scatter(Dsum(1,[1 3:8]),oddball_allFoot(17,[1 3:8]));
hold on;
